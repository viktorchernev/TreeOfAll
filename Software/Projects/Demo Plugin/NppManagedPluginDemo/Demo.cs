...
namespace Kbg.NppPluginNET
{
    ...
    class Main
    {
        ...
        { 
            get 
            { 
                return Kbg.Demo.Namespace.Main.PluginName; 
            }
        }
    }
}
...
namespace Kbg.Demo.Namespace
{
    class Main
    {
        ...
        static Bitmap tbBmp = Properties.Resources.describe;
        static Bitmap tbBmp_tbTab = Properties.Resources.describe;
        static Icon tbIco = Properties.Resources.star_black_ico;
        static Icon tbIcoDM = Properties.Resources.star_white_ico;
        ...
        static internal void CommandMenuInit()
        {
            ...
            PluginBase.SetCommand(4, "Current Full Path", insertCurrentFullPath, 
                new ShortcutKey(false, true, false, Keys.F));
            ...
            PluginBase.SetCommand(9, "Close HTML/XML tag automatically", checkInsertHtmlCloseTag, 
                new ShortcutKey(false, true, false, Keys.Q), doCloseTag);
        ...
        static void PrintScrollInformation()
        {
            ...
            editor.ReplaceSel(
                $@"The maximum row in the current document was {scrollInfo.nMax+1}.
        ...
        static internal void SetToolBarIcon()
        {
            ...
            Win32.SendMessage(
                ...
                PluginBase._funcItems.Items[idFrmGotToLine]._cmdID, 
                pTbIcons);
        ...
        static void DockableDlgDemo()
        {
            ...
            if (frmGoToLine == null)
            {
                ...
                _nppTbData.pszName = "DescribeR v0.1";
